...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const paintDropsModal = document.getElementById("paintDropsModal");
  const bookModalButton = document.getElementById("bookModalButton");
  ...
  const paintDropsButton = document.getElementById("paintDropsButton");
  ...
  paintDropsButton.addEventListener("click", function(event) {
    event.preventDefault();
    openModal(paintDropsModal);
  });
  bookModalButton.addEventListener("click",function(){
    event.preventDefault();
    openModal(bookModal);
  });
